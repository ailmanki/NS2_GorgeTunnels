...
local oldTunnelEntranceOnCreate = TunnelEntrance.OnCreate
function TunnelEntrance:OnCreate()
    oldTunnelEntranceOnCreate(self)
...
local oldTunnelEntranceOnInitialized =  TunnelEntrance.OnInitialized
function TunnelEntrance:OnInitialized()
    oldTunnelEntranceOnInitialized(self)
...
local oldTunnelEntranceSetVariant = TunnelEntrance.SetVariant
function TunnelEntrance:SetVariant(tunnelVariant)
    oldTunnelEntranceSetVariant(self, tunnelVariant)
    --[[
...
local oldTunnelEntranceGetCanBuildOtherEnd = TunnelEntrance.GetCanBuildOtherEnd
function TunnelEntrance:GetCanBuildOtherEnd()
    return not self:GetGorgeOwner() and oldTunnelEntranceGetCanBuildOtherEnd(self)
end

local oldTunnelEntranceGetCanTriggerCollapse = TunnelEntrance.GetCanTriggerCollapse
function TunnelEntrance:GetCanTriggerCollapse()
    return not self:GetGorgeOwner() and oldTunnelEntranceGetCanTriggerCollapse(self)
end

local oldTunnelEntranceGetCanRelocate = TunnelEntrance.GetCanRelocate
function TunnelEntrance:GetCanRelocate()
    return not self:GetGorgeOwner() and oldTunnelEntranceGetCanRelocate(self)
end
--[[
...
--[[
    ...
    local oldTunnelEntranceOnConstructionComplete = TunnelEntrance.OnConstructionComplete
    function TunnelEntrance:OnConstructionComplete()
        ...
        if self:GetGorgeOwner() then
            ...
            oldTunnelEntranceOnConstructionComplete(self)
            --[[
...
--[[
    ...
    local oldTunnelEntranceOnKill = TunnelEntrance.OnKill
    function TunnelEntrance:OnKill(attacker, doer, point, direction)
        oldTunnelEntranceOnKill(self, attacker, doer, point, direction)
--[[
