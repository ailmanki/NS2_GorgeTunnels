...
function AlienTeam:GetActiveTeamSkin()
    return self.activeStructureSkin
end

function AlienTeam:GetActiveTeamSkinSpecial()
    return self.activeTunnelSkin
end

function AlienTeam:SetTeamSkinVariant( skinIndex )
    self.activeStructureSkin = skinIndex  --TODO Better enum/range/value checking
end

function AlienTeam:SetTeamSkinSpecialVariant( skinIndex )
    self.activeTunnelSkin = skinIndex  --TODO Better enum/range/value checking
end
